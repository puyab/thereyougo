...
<x-splade-data
    ...
    <div class="w-full h-max flex flex-col gap-2">
        <div
            ...
            class='relative w-full bg-transparent border-0 border-b-[1px] border-b-black text-3xl font-light py-3
            cursor-pointer'>
            <div @click="data.open=!data.open" class="pl-2.5">
            ...
            <div v-show="data.open"
                 class="w-full h-max absolute z-30 top-[100%] left-0 bg-white border-[1px] border-black rounded-md flex flex-col items-center justify-center gap-2">
