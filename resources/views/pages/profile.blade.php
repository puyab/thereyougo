...
<section class="w-full h-max mx-auto px-10 lg:px-20 pb-[41px] lg:py-[82px] flex flex-col items-start justify-start">
    ...
    <div
        class="#lg:mt-[11rem] w-full flex flex-col-reverse gap-4 lg:flex-row lg:gap-8 lg:items-center lg:justify-start">
        ...
        <div class="w-full max-w-[523px] h-max flex flex-col items-center justify-between gap-16 ml-[15rem]">
            ...
            <iframe class="w-full h-[323px] max-w-[523px] hidden lg:block"
                src="https://maps.google.com/maps?key={{ config('google.key') }}&q={{ $profile->latitude }},{{ $profile->longitude }}&hl=es&z=14&amp;output=embed"></iframe>
        </div>
    </div>
</section>
