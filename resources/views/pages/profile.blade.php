...
<section
    class="w-full h-max max-w-[1384px] mx-auto px-7 lg:px-14 pb-[41px] lg:py-[82px] flex flex-col items-start justify-start">
    <div class="relative w-max max-w-full mx-auto h-max lg:h-[425px] lg:mt-[82px] lg:max-w-5xl hidden #grid grid-cols-1 lg:grid-cols-2 gap-4 place-items-center place-content-center data-[safari=true]:h-[1100px]  data-[safari=true]:lg:h-max"
        ...
        <figure class="w-full h-full min-w-[364px] min-h-[202px]">
            <img class="w-full h-full object-fill"
                src="{{ $images['pic_1'] === '' ? asset('images/not-found.jpg') : $images['pic_1'] }}" />
        </figure>
        <div class="w-full h-max grid grid-cols-1 gap-5 place-content-center place-items-center">
            <figure class="w-full min-w-[364px] h-[202px] max-h-[202px]">
                <img class="w-full h-full object-fill"
                    src="{{ $images['pic_2'] === '' ? asset('images/not-found.jpg') : $images['pic_2'] }}" />
            </figure>
            <figure class="w-full min-w-[364px] h-[202px] max-h-[202px]">
                <img class="w-full h-full object-fill"
                    src="{{ $images['pic_3'] === '' ? asset('images/not-found.jpg') : $images['pic_3'] }}" />
            </figure>
        </div>
        <div
            ...
            <figure
                ...
                <img class="w-full h-full object-fill"
                    src="{{ $images['avatar'] === '' ? asset('images/not-found.jpg') : $images['avatar'] }}" />
            </figure>
        </div>
        <div
            class="w-full flex flex-col gap-2 mb-2 lg:mb-0 lg:ml-[38rem] font-light text-xl md:text-2xl lg:text-4xl text-[#292D32]">
    ...
    <div class="#lg:mt-[11rem] w-full flex flex-col gap-4 lg:flex-row lg:gap-8 lg:items-center lg:justify-between">
        <div class="w-max max-w-full h-max flex flex-col gap-12 lg:max-w-2xl">
            ...
            <div class="w-max max-w-full h-max flex flex-col gap-12 lg:pl-11">
                <div class="w-full h-max flex flex-col items-start justify-start gap-8 mx-auto">
                    ...
                    <div
                        class="w-full flex flex-col gap-2 mb-2 font-light text-xl md:text-2xl lg:text-4xl text-[#292D32]">
                        <span>{{ $profile->first_name }} {{ $profile->last_name }}.</span>
                        <span>{{ $profile->role }}, {{ $profile->company }}</span>
                        <span>{{ $profile->location }}</span>
                    </div>
        ...
        <div class="w-full max-w-[410px] min-h-[408px] h-full flex flex-col items-center justify-between gap-4">
            <div class="w-full h-1/2 flex flex-col items-start justify-start gap-2">
                <span class="font-light text-xl md:text-2xl lg:text-3xl text-[#292D32]">Referral's Tracker</span>
                <div class="w-full h-full flex items-center justify-center border-[1px] border-black">
                    <span class="font-light text-6xl lg:text-[140px] text-[#292D32]">{{ $refs_count }}</span>
                </div>
            </div>
            <iframe class="w-full h-1/2 max-w-[410px] "
