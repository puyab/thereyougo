...
<section class="w-full h-max mx-auto px-10 lg:px-20 pb-[41px] lg:py-[82px] flex flex-col items-start justify-start">
  <div
    class="relative w-max max-w-full mx-auto h-max lg:h-[425px] lg:mt-[82px] lg:max-w-5xl hidden #grid grid-cols-1 lg:grid-cols-2 gap-4 place-items-center place-content-center data-[safari=true]:h-[1100px]  data-[safari=true]:lg:h-max"
  ...
  <div class="#lg:mt-[11rem] w-full flex flex-col-reverse gap-4 lg:flex-row lg:gap-8 lg:items-center lg:justify-center">
    ...
    <div class="w-full max-w-[410px] h-max flex flex-col items-center justify-between gap-4">
      <div class="w-full h-max flex flex-col items-center justify-center gap-2">
      ...
      <iframe class="w-full h-[323px] max-w-[410px] hidden lg:block"
              src="https://maps.google.com/maps?key={{ config('google.key') }}&q={{ $profile->latitude }},{{ $profile->longitude }}&hl=es&z=14&amp;output=embed"></iframe>
    </div>
  </div>
</section>
