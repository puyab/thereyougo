...
<section
    class="w-full bg-[#DEEBEC] mt-[57.5px] lg:mt-[115px] px-6 lg:px-20 py-10 lg:py-20 flex flex-col lg:flex-row-reverse items-center justify-center gap-10 lg:gap-8"
    id="dream">
