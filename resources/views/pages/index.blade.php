...
<section class="w-full h-max bg-[#D29A9A80] p-4 lg:py-9 lg:px-20 lg:pb-20 lg:pt-12 flex flex-col gap-4 lg:gap-16">
  ...
  <x-splade-data default="{open: false}">
    ...
    <div v-if="data.open" class="fixed inset-0 bg-black/30 z-50 flex items-center justify-center">
      <iframe class="w-11/12 h-5/6 border-none outline-none rounded-xl z-10" src="https://www.youtube.com/embed/TE_IvgXkYEs?si=Yl0Z17swjs3jvLEU&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<section class="w-full h-max px-6 lg:px-20 py-[45px] lg:py-[90px] flex flex-col gap-[81px] lg:gap-[162px]">
  ...
  <div class="w-full h-max grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-row lg:items-center lg:justify-between place-items-center place-content-center gap-y-4">
    ...
    <div class="w-full flex items-start justify-center gap-7 lg:gap-14 max-w-[500px]">
      ...
      <div class="w-full h-max flex flex-col items-start justify-start gap-5">
        ...
        <p class="w-full font-normal text-lg md:text-base lg:text-[19px] text-[#383838] leading-[28.8px] text-left">
          {{ $step['description'] }}
        </p>
      </div>
    </div>
...
<section id="faqs" class="w-full h-max px-6 lg:px-20 py-10 lg:py-20 bg-[#DEEBEC] flex flex-col items-start justify-start gap-4">
  ...
  <p class="text-xl md:text-2xl lg:text-3xl text-[#292D32] font-medium">Check out what your peers are asking us. If
    you have more questions contact us at <a href="mailto:info@thereyougo.eu" class="text-[#0711F4]">info@thereyougo.eu.</a></p>
</section>
