...
class RegisterUserToBrevo implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $contact = new CreateContact(['email' => $this->user->email, 'attributes' => ['FIRSTNAME' => $this->user->profile->first_name, 'LASTNAME' => $this->user->profile->last_name, 'SMS' => $this->user->profile->telephone]]);
